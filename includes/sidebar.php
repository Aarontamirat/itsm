...
?>
<!-- sidebar.php -->
<aside id="sidebar" class="bg-white dark:bg-gray-900 bg-opacity-95 dark:bg-opacity-95 rounded-2xl shadow-2xl min-h-full fixed top-0 transition-all duration-500 ease-in-out w-64 overflow-hidden z-10 flex flex-col tech-border glow border-2 border-cyan-200 dark:border-cyan-800">
