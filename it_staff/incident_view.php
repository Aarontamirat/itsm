...
<body>
    <div class="max-w-3xl mx-auto bg-white bg-opacity-95 rounded-2xl shadow-2xl px-8 py-10 fade-in tech-border glow mt-8 font-mono">
        ...
        <div class="flex flex-col md:flex-row justify-center items-center gap-4 mb-8">
            <a href="my_incidents.php" class="bg-gradient-to-r from-cyan-400 via-cyan-300 to-green-300 hover:from-green-300 hover:to-cyan-400 text-white font-bold rounded-lg shadow-lg px-6 py-2 transform hover:scale-105 transition duration-300 tracking-widest">
                &larr; Back to List
            </a>
        </div>
